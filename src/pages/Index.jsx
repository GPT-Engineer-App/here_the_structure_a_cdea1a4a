...
import { Box, Button, Container, Heading, Text, VStack, Image, useColorModeValue, Flex, HStack, Link } from "@chakra-ui/react";
      ...
      <VStack w="full" h="100vh" p={10} spacing={10} alignItems="flex-start" bg={bg}>
        <Flex as="nav" w="full" justifyContent="space-between" alignItems="center">
          ...
          <HStack spacing={4}>
            ...
            <Link to="/about-us"><Button variant="ghost" color={color}>
              Über uns
            </Button></Link>
            <Button variant="ghost" color={color}>
              Dienstleistungen
